...
const Promisa = () => {
    return new Promise((resolve) => {
        ...
        setTimeout(() => resolve(
            ...
            { id: "2", category: "deco", name: 'Reloj de pared', description: 'Ideal para decorar tus espacios y súper útil para poder ver el tiempo en cualquier momento. Tamaño 28cm.', price: 790, quantity: 7, image: 'https://static.olistshops.com/images/47a21f34-664e-4cbc-928d-742c200980a2.JPEG' },
            { id: "3", category: "holistica", name: 'Fuente de agua aljibe', description: 'Las fuentes de agua nos ayudan a mejorar la energía de nuestra casa, a armonizarla y también a generar lo que se denomina "la energía en movimiento", que ubicada en el lugar correcto trae excelentes resultados.', price: 3500, quantity: 5, image: 'https://static.olistshops.com/images/a553fce4-ab1c-4bc4-a37f-893c4314d838.JPEG' },
